            ...
            <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="grid gap-8 md:grid-cols-2 text-left">
                    <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
                        <h2 className="text-xl font-semibold text-green-300 mb-2">Why Boycott?</h2>
                    ...
                    <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
                        <h2 className="text-xl font-semibold text-green-300 mb-2">Our Vision</h2>
                        <p className="text-gray-400">
                    ...
                    <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
                        <h2 className="text-xl font-semibold text-green-300 mb-2">How You Can Help</h2>
                        <p className="text-gray-400">
                    ...
                    <div className="bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
                        <h2 className="text-xl font-semibold text-green-300 mb-2">Stay Informed</h2>
                        <p className="text-gray-400">
